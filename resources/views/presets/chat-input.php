...
return [
    'colors' => [
        ...
        'red' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-red-800 dark:text-red-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
        ...
        'blue' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-blue-800 dark:text-blue-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'green' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-green-800 dark:text-green-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'yellow' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-yellow-800 dark:text-yellow-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'purple' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-purple-800 dark:text-purple-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'pink' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-pink-800 dark:text-pink-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'gray' => [
            ...
            'label' => 'font-semibold text-gray-700 dark:text-gray-300/80 text-sm tracking-wide ml-1',
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-gray-800 dark:text-gray-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'orange' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-orange-800 dark:text-orange-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'amber' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-amber-800 dark:text-amber-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'lime' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-lime-800 dark:text-lime-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'emerald' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-emerald-800 dark:text-emerald-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'teal' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-teal-800 dark:text-teal-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'cyan' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-cyan-800 dark:text-cyan-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'sky' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-sky-800 dark:text-sky-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'indigo' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-indigo-800 dark:text-indigo-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'violet' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-violet-800 dark:text-violet-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'rose' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-rose-800 dark:text-rose-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'fuchsia' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-fuchsia-800 dark:text-fuchsia-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'slate' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-slate-800 dark:text-slate-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'stone' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-stone-800 dark:text-stone-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'zinc' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-zinc-800 dark:text-zinc-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
        ...
        'neutral' => [
            ...
            'label_error' => 'font-semibold text-red-500 text-sm tracking-wide ml-1',
            'input' => 'placeholder:text-sm w-full border-none !outline-none bg-transparent py-2 px-3 text-neutral-800 dark:text-neutral-100 min-h-0 resize-none overflow-hidden max-h-60 mr-1',
            'footer' => 'px-3 pb-2 pt-1 flex items-center justify-between',
            'help' => 'text-xs mt-1 text-neutral-400 dark:text-neutral-500',
            'error' => 'text-xs mt-1 text-red-500',
