...
return [
    'colors' => [
        ...
        'fuchsia' => [
            'checked' => 'peer-checked:bg-fuchsia-600',
            'bg' => 'bg-neutral-300 dark:bg-gray-700',
            'border' => '',
            'border_error' => 'ring-2 ring-red-500',
            'thumb' => 'bg-white',
            ...
            'focus_error' => 'focus:ring-2 focus:ring-red-500 focus:ring-offset-2',
            'active' => 'active:bg-fuchsia-700',
            'disabled' => 'opacity-60 cursor-not-allowed',
            'label' => 'text-gray-800 dark:text-gray-100',
            'label_error' => 'text-red-500',
        ],
        'slate' => [
            'checked' => 'peer-checked:bg-slate-600',
            'bg' => 'bg-neutral-300 dark:bg-gray-700',
            'border' => '',
            'border_error' => 'ring-2 ring-red-500',
            'thumb' => 'bg-white',
        ...
        'stone' => [
            'checked' => 'peer-checked:bg-stone-600',
            'bg' => 'bg-neutral-300 dark:bg-gray-700',
            'border' => '',
            'border_error' => 'ring-2 ring-red-500',
            'thumb' => 'bg-white',
        ...
        'zinc' => [
            'checked' => 'peer-checked:bg-zinc-600',
            'bg' => 'bg-neutral-300 dark:bg-gray-700',
            'border' => '',
            'border_error' => 'ring-2 ring-red-500',
            'thumb' => 'bg-white',
        ...
        'neutral' => [
            'checked' => 'peer-checked:bg-neutral-600',
            'bg' => 'bg-neutral-300 dark:bg-gray-700',
            'border' => '',
            'border_error' => 'ring-2 ring-red-500',
            'thumb' => 'bg-white',
